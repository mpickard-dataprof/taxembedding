...
#          |                                                                 #
##############################################################################
MODEL_PATH = "/home/mpickard/Projects/ustax/data/embeddings"
OUT_TABLE_PATH = "/home/mpickard/Projects/ustax/data/output_data/tst_script_corr.csv"
SIM_REL_PAIRS_PATH = "/home/mpickard/Projects/ustax/data/output_data/phrase_count_table.txt"
ANALOGIES_PATH = "/home/mpickard/Projects/ustax/data/output_data/google_analogies_filtered.txt"
...
def load_evals(model_list):
    ...
    for path in model_list:
        ...
        eval_list.append(store_pair_eval(loaded_model.wv.evaluate_word_pairs(SIM_REL_PAIRS_PATH, delimiter = " "),
...
def name_scrape(file_name):
    ...
    title_dict = {"Stopwords?" : stopwords_flag, "References Preserved?" : code_refs_flag,
                 "Training Algorithm" : embedding_type_flag, "Dimensions" : dimensions_flag,
                 "Window" : window_flag, "Minimum Count Threshold" : mwo_flag,
                  "Number of Training Epochs" : epoch_flag}
